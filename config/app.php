...
return [
    ...
    'debugBar'=>false,
    /**
     * Переписывание префиксов контроллеров;
     * выполняется в RemapPrefixMiddleware
     */
    'remapMethodsPrefix'=> [
        'Users'=>[
            //['methods'=>['index'],'fromPrefix'=>'Admin','toPrefix'=>['Manager']],
        ],
        'Courses'=>[
            ['methods'=>'all','fromPrefix'=>'Master','toPrefix'=>['Manager']]
        ],
    ],
    'cronCommandTemplate'=>'{SCHEDULE} {CONSOLE_PATH} {SHELL} {TASK} >> /var/log/lk_cron.log 2>&1',
    'YANDEX_MAP_KEY'=>'f1bc0f0d-1c81-4549-9fad-8695f8745f5d',
    /*
    ...
    'App' => [
        ...
        'defaultLocale' => env('APP_DEFAULT_LOCALE', 'ru-RU'),
        'defaultTimezone' => env('APP_DEFAULT_TIMEZONE', 'Europe/Moscow'),
        'base' => false,
        'dir' => 'src',
        'webroot' => 'webroot',
        'wwwRoot' => WWW_ROOT,
    ...
    /**
     * Disable auth request for DebugBar
     */
    'DebugKit'=>[
