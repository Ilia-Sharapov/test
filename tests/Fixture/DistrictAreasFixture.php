...
/**
 * DistrictAreasFixture
 */
class DistrictAreasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'search_string' => ['type' => 'string', 'length' => 500, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
