...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mode' => ['type' => 'string', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        'broadcasting' => ['type' => 'string', 'length' => 500, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'datetime' => '2020-12-13 17:41:43',
                'type_id' => 1,
                'mode' => 'Lorem ipsum dolor sit amet',
                'branch_id' => 1,
                'area_id' => 1,
                'venue_id' => 1,
                'broadcasting' => 'Lorem ipsum dolor sit amet',
            ],
        ];
        parent::init();
    }
